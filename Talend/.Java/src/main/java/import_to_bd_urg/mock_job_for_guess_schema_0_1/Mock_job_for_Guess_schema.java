...
package import_to_bd_urg.mock_job_for_guess_schema_0_1;
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url = "jdbc:mysql://127.0.0.1:3306/bd_urg?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
				java.sql.Connection conn = java.sql.DriverManager
						.getConnection(url, "root", "silva");
				...
				java.sql.ResultSet rs = stm
						.executeQuery("SELECT    `urg_inform_geral`.`id_Urgencia`,    `urg_inform_geral`.`tempo_adm_alta`,    `urg_inform_geral`.`idade_paciente`,    `urg_inform_geral`.`idDIM_ESPECIALIDADE`,    `urg_inform_geral`.`idDIM_LOCAL`,    `urg_inform_geral`.`idDIM_PROVENIENCIA`,    `urg_inform_geral`.`idDIM_GENERO`,    `urg_inform_geral`.`idDIM_CAUSA`,    `urg_inform_geral`.`id_DATA_adm`,    `urg_inform_geral`.`id_DATA_alta`,    `urg_inform_geral`.`id_DATA_nascimento` FROM `urg_inform_geral`");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"C:/Users/Rafael/Desktop/TOS_BD-20181026_1147-V7.1.1/temp/TempGuessSchemaDelimitedFile.csv"))
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class
					.getClassLoader().getResourceAsStream(
							"import_to_bd_urg/mock_job_for_guess_schema_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = Mock_job_for_Guess_schema.class
						.getClassLoader()
						.getResourceAsStream(
...
/************************************************************************************************
 * 36760 characters generated by Talend Open Studio for Big Data on the 25 de
 * Dezembro de 2018 14:22:23 GMT
 ************************************************************************************************/
